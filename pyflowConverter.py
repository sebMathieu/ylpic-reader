...
def displayHelp():
	...
	text+="\tpython pyflowConverter.py dataFolder slackBusId year scenario [outputFolder]\n"
	print(text)
...
# @param caseName
# @param slackBusId Id of the slack bus.
# @param period.
def makePyflowFile(fileName, networkGraph, caseName, slackBusId, period):
